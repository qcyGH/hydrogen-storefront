 ...
 * Create a cart with line(s) mutation
 * @param cartId the current cart id
 * @param lines [CartLineUpdateInput!]! The merchandise lines to update.
 * @see https://shopify.dev/docs/api/storefront/2023-04/mutations/cartlinesupdate
 * @returns mutated cart
 * @preserve
 */
export async function cartLinesUpdate({cartId, lines, storefront}) {
  ...
  if (!cartLinesUpdate) {
    throw new Error('No data returned from update lines mutation');
  }
